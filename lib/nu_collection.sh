...
# nuOS 0.0.9.2d12 - lib/nu_collection.sh - LICENSE: BSD_SMPL
#
...
collection_vars_init () {
	...
	COLL_desktop='server graphics/gimp x11/xorg x11/kde4 net/x11vnc net/tightvnc www/firefox mail/thunderbird editors/libreoffice multimedia/vlc'
}

...
collection_vars_init () {
	...
	COLL_lite='bare sysutils/screen misc/buffer sysutils/pipemeter archivers/lzop sysutils/smartmontools net/rsync security/sudo'
	COLL_developer='lite devel/subversion devel/git'
	COLL_server='developer mail/postfix sysutils/pefs-kmod security/gnupg dns/unbound dns/djbdns net/openldap24-server security/openvpn ftp/pure-ftpd net/isc-dhcp42-server net/netatalk3 net/samba36 security/tor net-p2p/rtorrent net-p2p/bitcoin-daemon net-p2p/bitcoin-utils finance/vanitygen net-p2p/namecoin-daemon net-p2p/litecoin-daemon multimedia/ffmpeg graphics/optipng graphics/gifsicle textproc/rubygem-compass lang/expect databases/postgresql94-server databases/mysql56-server databases/mongodb databases/redis www/npm www/apache24 www/nginx mail/cyrus-imapd25 security/cyrus-sasl2-saslauthd net-im/ejabberd lang/phantomjs lang/clojure textproc/rubygem-sass emulators/virtualbox-ose graphics/povray-meta graphics/graphviz x11-fonts/webfonts lang/php56-extensions www/mod_php56 mail/roundcube-sieverules irc/irssi'

...
collection_vars_init () {
	...
	COLL_desktop='server graphics/gimp x11/xorg x11/kde4 net-p2p/bitcoin net-p2p/litecoin net-p2p/retroshare net/x11vnc net/tightvnc www/firefox mail/thunderbird editors/libreoffice multimedia/vlc net-p2p/qbittorrent'
}

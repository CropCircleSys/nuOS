...
collection_vars_init () {
	...
	COLL_server='developer mail/postfix sysutils/pefs-kmod security/gnupg dns/djbdns security/openvpn ftp/pure-ftpd net/isc-dhcp42-server net/netatalk3 net/samba36 security/tor www/polipo net-p2p/rtorrent finance/vanitygen net-p2p/namecoin-daemon net-p2p/litecoin-daemon lang/expect databases/postgresql93-server databases/mysql56-server databases/mongodb databases/redis www/npm www/apache24 www/nginx mail/cyrus-imapd24 security/cyrus-sasl2-saslauthd lang/phantomjs lang/clojure emulators/virtualbox-ose graphics/povray-meta graphics/graphviz x11-fonts/webfonts lang/php56-extensions www/mod_php56 mail/roundcube-sieverules irc/irssi'
